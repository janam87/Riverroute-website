    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 70deg at center top, #C9973A, transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 290deg at center top, transparent, transparent, #C9973A)`,
          }}
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-navy blur-2xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-gold/80 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
        ...
        ></motion.div>
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-navy"></div>
      </div>
